...
addLayer("a", {
    ...
    resource: "achieve",        // The name of this layer's main prestige resource.
...
addLayer("d", {
    ...
    color: "#18780b",                       // The color for this layer, which affects many elements.
    resource: "ducks",        // The name of this layer's main prestige resource.
...
addLayer("fd", {
    ...
    color: "#964B00",                       // The color for this layer, which affects many elements.
    resource: "food",        // The name of this layer's main prestige resource.
    row: 0,                                 // The row this layer is on (0 is the first row).
    position: 0,
    branches: ["ft", "b"],
