addLayer("light", {
  ...
  bars: {
    ...
    lightHealing: {
      ...
      height: 20,
      progress() {
        return tmp[this.layer].magicLevels.healing.capProgress
      }
    },
    lightBlessing: {
      direction: RIGHT,
      ...
      height: 20,
      progress() {
        return tmp[this.layer].magicLevels.blessing.capProgress
      }
    },
    lightLumen: {
      direction: RIGHT,
      ...
      height: 20,
      progress() {
        return tmp[this.layer].magicLevels.lumen.capProgress
      }
    }
  },
	infoboxes: {
    ...
    spellbook: {
      healing: {
        ...
        content: [
          ...
          "blank",
          ["display-text", function() {
            return format[this.layer].lightHealing + " Healing Points"
          }],
          "blank",
          ["bar", "lightHealingPoints"],
          "blank",
          "h-line",
          "blank",
          ["spells", 111],
      ...
      blessing: {
        ...
        content: [
          ...
          "blank",
          ["display-text", function() {
            return format[this.layer].lightBlessing + " Blessing Points"
          }],
          "blank",
          ["bar", "lightBlessingPoints"],
          "blank",
          "h-line",
          "blank",
          ["spells", 211],
      ...
      lumen: {
        ...
        content: [
          ...
          "blank",
          ["display-text", function() {
            return format[this.layer].lightLumen + " Lumen Points"
          }],
          "blank",
          ["bar", "lightLumenPoints"],
          "blank",
          "h-line",
          "blank",
          ["spells", 311],
