...
function getStartOptions() {
	return {
		...
		StarsPlanetsMilestonePopups: true,
		ComAstMilestonePopup: true,
		AchievementPopup: true,
		UnstableFuelMilestonePopup: true,
		GalaxyMilestonePopup: true,
		DarkmatterMilestonePopup: true,
		SupernovaPopup: true,
		BlackHolePopup: true,
...
function adjustMSDisp() {
	options.msDisplay =
		MS_SETTINGS[(MS_SETTINGS.indexOf(options.msDisplay) + 1) % 2];
}
