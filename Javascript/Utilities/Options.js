...
function toggleOpt(name) {
	...
	if (name == "oldStyle")
		updateStyle();
	if (name == "resourcePanelShow") {
		if (options.enableResourcePanel === true) {
			options.enableResourcePanel = false
		} else {
			options.enableResourcePanel = true
		}
	}
}
var styleCooldown = 0;
