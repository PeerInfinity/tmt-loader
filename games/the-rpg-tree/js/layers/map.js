...
addLayer('m', {
    ...
    upgrades: {
        11: {
            ...
            unlocked() {
                // Visible at the Village
                return player.m.location == 45 && challengeCompletions('q', 12) > 0;
            },
        },
        12: {
            title: 'Stable',
    ...
    microtabs: {
        tabs: {
            'Tavern': {
                embedLayer: 't',
                embedLayer() {
                    if (player.m.location == 45 && hasUpgrade('m', 11)) {
                        return 't';
                    }
                    return '';
                },
                unlocked() { return player.m.location == 45 && hasUpgrade('m', 11); },
            }
        }
    },
    tabFormat: [
