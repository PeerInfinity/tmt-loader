...
addLayer("c",{
    ...
    clickables: {
        ...
        STR: {
            title: "Get Strong",
            unlocked() { return player.str.points.eq(0) },
            display() {
        ...
        DEX: {
            title: "Get Fast",
            unlocked() { return player.dex.points.eq(0) },
            display() {
        ...
        CON: {
            title: "Get Tough",
            unlocked() { return player.con.points.eq(0) },
            display() {
        ...
        INT: {
            title: "Get Smart",
            unlocked() { return player.int.points.eq(0) },
            display() {
        ...
        WIS: {
            title: "Get Wise",
            unlocked() { return player.wis.points.eq(0) },
            display() {
        ...
        CHA: {
            title: "Get Nice",
            unlocked() { return player.cha.points.eq(0) },
            display() {
    ...
    microtabs: {
        tabs: {
            'Character': {
                unlocked() {
                    // If all are unlocked, we don't need this tab
                    if (player.str.points.gt(0) && player.dex.points.gt(0) &&
                        player.con.points.gt(0) && player.int.points.gt(0) &&
                        player.wis.points.gt(0) && player.cha.points.gt(0)) {
                        return false;
                    }
                    return true;
                },
