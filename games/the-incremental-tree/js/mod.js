let modInfo = {
	...
	author: "liam",
	pointsName: "points",
	modFiles: ["tree.js", "p.js", "m.js", "pt.js", "e.js", "n.js", 'r.js', 'q.js', 'i.js'],
...
<h3>v5.0.0</h3><br>
		...
		- Fixed prestige generation<br>
		- Fixed the prestige and research hotkeys<br>
		- Fixed the spelling of 'labatory' to the right one<br>
		- Thank you guys for all the feedback and telling me about the bugs, they are fixed (:<br>
...
if (hasChallenge('n', 32)) gain = gain.pow(1.03)
		...
		if (hasUpgrade("q", 34)) gain = gain.pow(1.08);
...
if (hasMilestone('i', 1)) gain = gain.pow(1.03)
	if (hasMilestone('i', 2)) gain = gain.pow(1.03)
...
var displayThings = [
		function() {if (true) return "endgame: 2 total inflation points"},
...
function isEndgame() {
	return player.i.total.gte(new Decimal(2))
}
