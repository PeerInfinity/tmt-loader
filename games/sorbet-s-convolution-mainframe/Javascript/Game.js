...
function generatePoints(layer, diff) {
	addPoints(layer, tmp[layer].resetGain.times(diff).times(player.timeDilationScale))
}
...
function gameLoop(diff) {
	...
	player.timeDilationScale = getDilation()

	player.points = player.points.add(tmp.pointGen.times(diff).times(player.timeDilationScale)).max(0)
	if (player.universe.points.gte(10)) player.universe.godParticles = player.universe.godParticles.add(player.universe.godProduction().times(diff).times(player.timeDilationScale)).max(0)
	if (hasMilestone("universe", 18)) player.LPrestige.points = player.LPrestige.points.add(player.LPrestige.prod().times(diff).times(player.timeDilationScale)).max(0)
	if (hasMilestone("universe", 29)) {
		player.sorbet.colors.pure = player.sorbet.colors.pure.add(player.sorbet.colors.pureProd().times(diff).times(player.timeDilationScale)).max(0)
		player.sorbet.colors.dark = player.sorbet.colors.dark.add(player.sorbet.colors.darkProd().times(diff).times(player.timeDilationScale)).max(0)
	}
	if (hasMilestone("universe", 30)) {
		player.sorbet.colors.greenCrystal = player.sorbet.colors.greenCrystal.add(player.sorbet.colors.greenProd().times(diff).times(player.timeDilationScale)).max(0)
		player.sorbet.colors.redCrystal = player.sorbet.colors.redCrystal.add(player.sorbet.colors.redProd().times(diff).times(player.timeDilationScale)).max(0)
	}
	if (hasMilestone("universe", 31)) {
		player.sorbet.colors.shark = player.sorbet.colors.shark.add(player.sorbet.colors.sharkProd().times(diff).times(player.timeDilationScale)).max(0)
		player.sorbet.colors.ink = player.sorbet.colors.ink.add(player.sorbet.colors.inkProd().times(diff).times(player.timeDilationScale)).max(0)
	}
	if (hasMilestone("universe", 32)) {
		player.sorbet.colors.mimic = player.sorbet.colors.mimic.add(player.sorbet.colors.mimicProd().times(diff).times(player.timeDilationScale)).max(0)
	}
	if (hasMilestone("universe", 33)) {
		player.sorbet.colors.true = player.sorbet.colors.true.add(player.sorbet.colors.trueProd().times(diff).times(player.timeDilationScale)).max(0)
	}
	if (hasMilestone("universe", 34)) {
		player.sorbet.colors.plant = player.sorbet.colors.plant.add(player.sorbet.colors.plantProd().times(diff).times(player.timeDilationScale)).max(0)
		player.sorbet.colors.magma = player.sorbet.colors.magma.add(player.sorbet.colors.magmaProd().times(diff).times(player.timeDilationScale)).max(0)
		player.sorbet.colors.alien = player.sorbet.colors.alien.add(player.sorbet.colors.alienProd().times(diff).times(player.timeDilationScale)).max(0)
	}
	if (hasMilestone("universe", 38)) {
		player.colin.distance = player.colin.distance.add(player.colin.speed.times(diff).times(player.timeDilationScale)).max(0)
	}
